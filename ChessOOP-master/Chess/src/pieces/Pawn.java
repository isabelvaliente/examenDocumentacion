...
/**
 * Esta es la Clase de Peón heredada de la pieza
 *
 */
public class Pawn extends Piece {
	...
	public ArrayList<Cell> move(Cell state[][], int x, int y) {
		// El peón puede moverse solo un paso excepto en la primera oportunidad en la
		// que puede moverse 2 pasos
		// Puede moverse en diagonal solo para atacar una pieza de color opuesto
		// No puede moverse hacia atrás o hacia adelante para atacar una pieza
